...
const TBBUTTON defaultButtons[] = {
	...
	{ IDB_FAVOR,     ID_TOOLBAR_FAVOR,    TBSTATE_ENABLED,  TBSTYLE_DROPDOWN, {0,0}, 0, 0},
	{ IDB_REFRESH,   ID_TOOLBAR_REFRESH,  TBSTATE_ENABLED,  BTNS_BUTTON,      {0,0}, 0, 0},
	{ IDB_UP,        ID_TOOLBAR_UP,       TBSTATE_ENABLED,  BTNS_BUTTON,      {0,0}, 0, 0},
	{ 0,             0,                   TBSTATE_ENABLED,  TBSTYLE_SEP,      {0,0}, 0, 0},
	{ IDB_READ,      ID_TOOLBAR_READ,     TBSTATE_ENABLED,  BTNS_BUTTON,      {0,0}, 0, 0},
	{ IDB_DETAIL,    ID_TOOLBAR_DETAIL,   TBSTATE_ENABLED,  BTNS_BUTTON,      {0,0}, 0, 0},
	{ IDB_DELETE,    ID_TOOLBAR_DELETE,   TBSTATE_ENABLED,  BTNS_BUTTON,      {0,0}, 0, 0},
	{ 0,             0,                   TBSTATE_ENABLED,  TBSTYLE_SEP,      {0,0}, 0, 0},
	{ IDB_PULL,      ID_TOOLBAR_PULL,     TBSTATE_ENABLED,  BTNS_BUTTON,      {0,0}, 0, 0},
	{ IDB_PUSH,      ID_TOOLBAR_PUSH,     TBSTATE_ENABLED,  BTNS_BUTTON,      {0,0}, 0, 0},
};
